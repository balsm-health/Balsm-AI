---
name: domain-driven-design-planner
description: "Decide whether full DDD is worth it, then plan and route Domain-Driven Design work from strategic modeling to tactical implementation and evented architecture (CQRS, event sourcing, sagas, projections). Use for the up-front viability check and staged planning; for the in-depth DDD manual (bounded contexts, aggregates, ubiquitous language, repositories) use domain-driven-design."
risk: safe
