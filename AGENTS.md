...
|---|---|---|
| analyzing-android-malware-with-apktool | Perform static analysis of Android APK malware samples using apktool for decompilation, jadx for Java source recovery, and androguard for… | `plugin/skills/analyzing-android-malware-with-apktool/SKILL.md` |
| analyzing-email-headers-for-phishing-investigation | Parse and analyze email headers to trace the origin of phishing emails, verify sender authenticity, and identify spoofing through SPF, DK… | `plugin/skills/analyzing-email-headers-for-phishing-investigation/SKILL.md` |
| analyzing-indicators-of-compromise | 'Analyzes indicators of compromise (IOCs) including IP addresses, domains, file hashes, URLs, and email artifacts to determine maliciousn… | `plugin/skills/analyzing-indicators-of-compromise/SKILL.md` |
| analyzing-ios-app-security-with-objection | >- Runtime iOS app security testing with Objection (Frida): inspect keychain and filesystem data, explore app internals at runtime, and v… | `plugin/skills/analyzing-ios-app-security-with-objection/SKILL.md` |
...
| exploiting-http-request-smuggling | Detecting and exploiting HTTP request smuggling vulnerabilities caused by Content-Length and Transfer-Encoding parsing discrepancies betw… | `plugin/skills/exploiting-http-request-smuggling/SKILL.md` |
| exploiting-idor-vulnerabilities | Identifying and exploiting Insecure Direct Object Reference vulnerabilities to access unauthorized resources by manipulating object ident… | `plugin/skills/exploiting-idor-vulnerabilities/SKILL.md` |
| exploiting-insecure-data-storage-in-mobile | 'Identifies and exploits insecure local data storage vulnerabilities in Android and iOS mobile applications including unencrypted databas… | `plugin/skills/exploiting-insecure-data-storage-in-mobile/SKILL.md` |
| exploiting-insecure-deserialization | Identifying and exploiting insecure deserialization vulnerabilities in Java, PHP, Python, and .NET applications to achieve remote code ex… | `plugin/skills/exploiting-insecure-deserialization/SKILL.md` |
| exploiting-mass-assignment-in-rest-apis | Discover and exploit mass assignment vulnerabilities in REST APIs to escalate privileges, modify restricted fields, and bypass authorizat… | `plugin/skills/exploiting-mass-assignment-in-rest-apis/SKILL.md` |
| exploiting-nosql-injection-vulnerabilities | Detect and exploit NoSQL injection vulnerabilities in MongoDB, CouchDB, and other NoSQL databases to demonstrate authentication bypass, d… | `plugin/skills/exploiting-nosql-injection-vulnerabilities/SKILL.md` |
| exploiting-server-side-request-forgery | Identifying and exploiting SSRF vulnerabilities to access internal services, cloud metadata, and restricted network resources during auth… | `plugin/skills/exploiting-server-side-request-forgery/SKILL.md` |
...
| implementing-cloud-security-posture-management | 'Implementing Cloud Security Posture Management (CSPM) to continuously monitor multi-cloud environments for misconfigurations, compliance… | `plugin/skills/implementing-cloud-security-posture-management/SKILL.md` |
...
| testing-for-xss-vulnerabilities-with-burpsuite | Identifying and validating cross-site scripting vulnerabilities using Burp Suite's scanner, intruder, and repeater tools during authorize… | `plugin/skills/testing-for-xss-vulnerabilities-with-burpsuite/SKILL.md` |
| testing-for-xxe-injection-vulnerabilities | Discovering and exploiting XML External Entity injection vulnerabilities to read server files, perform SSRF, and exfiltrate data during a… | `plugin/skills/testing-for-xxe-injection-vulnerabilities/SKILL.md` |
| testing-jwt-token-security | Assessing JSON Web Token implementations for cryptographic weaknesses, algorithm confusion attacks, and authorization bypass vulnerabilit… | `plugin/skills/testing-jwt-token-security/SKILL.md` |
| testing-mobile-api-authentication | 'Tests authentication and authorization mechanisms in mobile application APIs to identify broken authentication, insecure token managemen… | `plugin/skills/testing-mobile-api-authentication/SKILL.md` |
| testing-oauth2-implementation-flaws | 'Tests OAuth 2.0 and OpenID Connect implementations for security flaws including authorization code interception, redirect URI manipulati… | `plugin/skills/testing-oauth2-implementation-flaws/SKILL.md` |
| triaging-security-incident | 'Performs initial triage of security incidents to determine severity, scope, and required response actions using the NIST SP 800-61r3 and… | `plugin/skills/triaging-security-incident/SKILL.md` |
